...
class gd {
	...
	/**
	 * Returns an array.
	 * Element 0 - GD resource. Element 1 - width. Element 2 - height.
	 ...
	 * 1.
	 * An instance of this class (copy instance).
	 * 2. A GD resource.
	...
	public function resize($width, $height) {
		...
		if (! $height)
			$height = 1;
		return ((false !== ($img = new gd ( array (
				$width,
				$height 
		) ))) && $img->imagecopyresampled ( $this ) && (false !== ($this->image = $img->get_image ())) && (false !== ($this->width = $img->get_width ())) && (false !== ($this->height = $img->get_height ())));
	}
