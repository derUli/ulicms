...
class uploader {
	...
	/**
	 * Contain unprocessed $_GET array.
	 * Please use this instead of $_GET
	 *
	 * @var array
	 */
	protected $get;
	...
	/**
	 * Contain unprocessed $_POST array.
	 * Please use this instead of $_POST
	 *
	 * @var array
	 */
	protected $post;
	...
	/**
	 * Contain unprocessed $_COOKIE array.
	 * Please use this instead of $_COOKIE
	 *
	 * @var array
	 */
	protected $cookie;
	...
	public function __construct() {
		...
		if (isset ( $this->get ['cms'] ) && in_array ( $this->get ['cms'], array (
				"drupal" 
		) ))
