...
class AntispamHelperTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testIsChineseReturnsTrue(): void {
        // Only chinese
 ...
 Büchstäbem'));
    ...
    public function testIsChineseReturnsFalse(): void {
        // Only Latin
    ...
    public function testIsCyrillicReturnsTrue(): void {
        // Only cyrillic
 ...
 Büchstäbem'));
    ...
    public function testIsCyrillicReturnsFalse(): void {
        // Only Latin
    ...
    public function testIsRtlReturnsTrue(): void {
    ...
    public function testIsRtlReturnsFalse(): void {
     ...
     * @medium
     */
    public function testIsCountryBlockedReturnsTrue(): void {
     ...
     * @medium
     */
    public function testIsCountryBlockedReturnsFalse(): void {
        Settings::set('country_blacklist', 'vn,jp,at,tr');
    ...
    public function testCheckForBotWithoutArgumentReturnsTrue(): void {
        $_SERVER['HTTP_USER_AGENT'] = 'libwww-perl/5.65';
        $this->assertTrue(AntiSpamHelper::checkForBot());
    }

    public function testCheckForBotWithoutUseragentReturnsTrue(): void {
        $this->assertFalse(AntiSpamHelper::checkForBot());
    }

    public function testCheckForBotReturnsFalse(): void {
    ...
    public function testCheckMailDomainMxReturnsTrue(): void {
    ...
    public function testCheckMailDomainMxReturnsFalse(): void {
        // non existing domain
