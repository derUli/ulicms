...
class ModuleTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testMetaReturnsNull2() {
        $module = new Module('not_found');
        $this->assertNull($module->getMeta());
    }

    public function testGetMainControllerReturnsController(): void {
        $module = new Module('fortune2');
        $this->assertInstanceOf('Fortune', $module->getMainController('fortune2'));
    }
