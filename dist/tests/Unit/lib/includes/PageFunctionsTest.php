...
class PageFunctionsTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testGetPageTitleByID(): void {
        $allPages = ContentFactory::getAll();
        $first = $allPages[0];
    ...
    public function testGetPageByIDReturnsNull(): void {
        $this->assertNull(getPageById(PHP_INT_MAX));
    }

    public function testGetPageByIDReturnsObject(): void {
    ...
    public function testGetAllPagesWithTitle(): void {
    ...
    public function testGetAllSlugsByLanguage(): void {
    ...
    public function testGetAllPagesWithHashLinks(): void {
    ...
    public function testGetAllPagesWithoutHashLinks(): void {
    ...
    public function testGetAllPagesByLanguage(): void {
    ...
    public function testGetAllPagesByMenu(): void {
    ...
    public function testGetAllPagesByLanguageAndMenu(): void {
