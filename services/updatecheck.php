...
if($version == "7.0.0")
   ...
   <a href=\"http://ulicms.de/content/files/Releases/Upgrades/ulicms-7.0.0-auf-ulicms-7.1.2-upgrade.zip\">Download</a></p>");

if($version == "7.1.2" or $version == "7.1.3")
   die("<p>Ein Update auf UliCMS 7.2.0 ist verfügbar.<br/>
   <a href=\"http://ulicms.de/content/files/Releases/Upgrades/ulicms-7.1.2-auf-7.2.0-upgrade.zip\">Download</a></p>");
