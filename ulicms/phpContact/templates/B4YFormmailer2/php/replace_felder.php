 ...
 * Attachement
 */
  $b4yf_wildcard = str_replace("§§DATEI_FILESIZE§§", $phpContact_anhang_size, $b4yf_wildcard);
  $b4yf_wildcard = str_replace("§§ERROR-DATEI-FILEALLOWED§§", $phpContact_anhang_disallowed, $b4yf_wildcard);
