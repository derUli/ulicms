...
$b4yf_param[2]='activate|feld:1|active|active|%%EMPFAENGER%%|%%ACTIVATE%%';
$b4yf_param[3]='required|feld:1|yes|yes|%%EMPFAENGER%%|%%REQURIED%%';
$b4yf_param[4]='activate|feld:2|active|active|%%FIRMA%%|%%ACTIVATE%%';
$b4yf_param[5]='required|feld:2|yes||%%FIRMA%%|%%REQURIED%%';
$b4yf_param[6]='activate|feld:3|active|active|%%NAME%%|%%ACTIVATE%%';
$b4yf_param[7]='required|feld:3|yes|yes|%%NAME%%|%%REQURIED%%';
$b4yf_param[8]='activate|feld:4|active|active|%%EMAIL%%|%%ACTIVATE%%';
$b4yf_param[9]='required|feld:4|yes|yes|%%EMAIL%%|%%REQURIED%%';
$b4yf_param[10]='activate|feld:5|active|active|%%WEB%%|%%ACTIVATE%%';
$b4yf_param[11]='required|feld:5|yes||%%WEB%%|%%REQURIED%%';
$b4yf_param[12]='activate|feld:6|active|active|%%BETREFF%%|%%ACTIVATE%%';
$b4yf_param[13]='required|feld:6|yes|yes|%%BETREFF%%|%%REQURIED%%';
$b4yf_param[14]='activate|feld:7|active|active|%%NACHRICHT%%|%%ACTIVATE%%';
$b4yf_param[15]='required|feld:7|yes|yes|%%NACHRICHT%%|%%REQURIED%%';
$b4yf_param[16]='feldactivate|feld:8|active|active|%%ANHANG%%|%%ACTIVATE%%';
$b4yf_param[17]='feldactivate|feld:9;feld:10|active|active|%%TEXT_CAPTCHA%%|%%ACTIVATE%%';
$b4yf_param[18]='feldactivate|feld:11|active|active|%%KOPIE%%|%%ACTIVATE%%';
$b4yf_param[19]='feldactivate|feld:13|active|active|%%BUTTON_LOESCHEN_KONFIG%%|%%ACTIVATE%%';
...
$b4yf_param[46]='textarea|wildcard:HEADER||Treten Sie mit unserem Kontaktformular ganz einfach und bequem mit dem Webmaster in Verbindung.|%%WILDCARD01_HEAD%%|%%WILDCARD01_INFO%%';
$b4yf_param[47]='textarea|wildcard:FOOTER|||%%WILDCARD02_HEAD%%|%%WILDCARD02_INFO%%';
