...
$b4yf_param[11]='textarea|wildcard:HEADER||<div>  <strong>Mit unserem Upload Formular können Sie uns bequem Ihre Dokumente schicken.</strong><br /><br />Information - Pflichtangaben:<br /><br /><ul><li>Eingabefelder mit fett geschriebenem Titel sind Pflichtfelder.</li><li>Die 1. Datei muss gewählt werden, alle weiteren Dateien sind optional.</li><li>Erlaubte Dateien: ZIP, PDF, JPG, PNG, GIF, MP3, TXT, DOC und XLS</li><li>Erlaubte Dateigröße: Die 1. Datei 3MB, und jede weitere Datei 1MB</li></ul></div>|%%WILDCARD01_HEAD%%|%%WILDCARD01_INFO%%';
$b4yf_param[12]='textarea|wildcard:FOOTER|||%%WILDCARD02_HEAD%%|%%WILDCARD02_INFO%%';
