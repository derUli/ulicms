INSERT INTO `{prefix}content` (`id`, `slug`, `title`, `target`, `content`, `language`, `active`, `created`, `lastmodified`, `author_id`, `category_id`, `lastchangeby`, `views`, `link_url`, `menu`, `position`, `parent_id`, `access`, `meta_description`, `deleted_at`) VALUES
