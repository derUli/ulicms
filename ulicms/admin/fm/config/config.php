...
$config = array(
    ...
    */
    ...
    // TODO: implement this permissions for UliCMS groups
    'delete_files'                            => $isPermitted,
    'create_folders'                          => $isPermitted,
    'delete_folders'                          => $isPermitted,
    'upload_files'                            => $isPermitted,
    'rename_files'                            => $isPermitted,
    'rename_folders'                          => $isPermitted,
    'duplicate_files'                         => $isPermitted,
    'extract_files'                           => $isPermitted,
    'copy_cut_files'                          => $isPermitted, // for copy/cut files
    'copy_cut_dirs'                           => $isPermitted, // for copy/cut directories
    'chmod_files'                             => $isPermitted, // change file permissions
    'chmod_dirs'                              => $isPermitted, // change folder permissions
    'preview_text_files'                      => $isPermitted, // eg.: txt, log etc.
    'edit_text_files'                         => $isPermitted, // eg.: txt, log etc.
    'create_text_files'                       => $isPermitted, // only create files with exts. defined in $config['editable_text_file_exts']
