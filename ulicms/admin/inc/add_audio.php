...
<form action="index.php?action=audio" method="post" enctype="multipart/form-data">
...
<input name="mp3_file" type="file"><br/><br/>
<input type="submit" value="<?php translate("UPLOAD_audio");?>">
</form>
<?php 
} 
else {
