...
<input type="text" required="true" style="width:300px;" name="admin_lastname" value="">
<br/><br/>
<strong>Vorname:</strong><br/>
<input type="text" required="true" style="width:300px;" name="admin_firstname" value=""><br/><br/>
<strong>Email:</strong><br/>
<input type="email" required="true" style="width:300px;" name="admin_email" value=""><br/><br/>
...
<input type="password" required="true" style="width:300px;" name="admin_password" value=""><br/><br/>

<strong>Passwort wiederholen:</strong><br/>
<input type="password" required="true" style="width:300px;" name="admin_password_repeat" value=""><br/><br/>
