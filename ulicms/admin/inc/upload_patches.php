...
if (! $acl->hasPermission ( "upload_patches" )) {
  ...
  if(isset($_POST["upload_patch"]) and isset($_FILES['file']['tmp_name']) and startsWith($_FILES['file']['name'], ".zip")){
...
<p><strong><?php translate("description");?></strong>
<br/>
<input type="text" name="description" value="" required="true"/>
</p>

<p><strong><?php translate("file");?></strong>
<br/>
<input name="file" type="file" required="true"/>
</p>
    <input type="submit" name="upload_patch" value="<?php translate("install_patch");?>" />
</form>
<?php }?>