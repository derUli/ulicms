...
if ($_POST ["edit_page"] == "edit_page" && $acl->hasPermission ( "pages" )) {
	...
	article_author_name='$article_author_name' AND article_auhtor_email = '$article_auhtor_email' and article_image = '$article_image' and article_date = '$article_date' WHERE id=$id";
