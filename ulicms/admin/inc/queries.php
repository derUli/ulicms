...
if ($_POST ["edit_page"] == "edit_page" && $acl->hasPermission ( "pages" )) {
	...
	og_title = '$og_title', og_type ='$og_type', og_image = '$og_image', og_description='$og_description', `type` = '$type', `module` = $module, `video` = $video, `audio` = $audio, text_position = '$text_position', autor = $autor $approved_sql, image_url = $image_url WHERE id=$id";
	var_dump ( $sql );
