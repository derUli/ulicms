...
if ($_POST ["add_page"] == "add_page" && $acl->hasPermission ( "pages" )) {
  ...
  VALUES('$system_title','$page_title','$page_content',$parent, $activated," . time () . ", " . time () . "," . $_SESSION ["login_id"] . ", " . $comments_enabled . ", '$redirection', '$menu', $position, '" . $access . "',
...
if ($_POST ["edit_page"] == "edit_page" && $acl->hasPermission ( "pages" )) {
	...
	only_owner_can_edit = $only_owner_can_edit, only_others_can_edit = $only_others_can_edit WHERE id=$id";
