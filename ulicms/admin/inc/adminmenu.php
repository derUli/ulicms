...
<ul class="menu">
  <li>
    <a href='?action=home'><?php echo TRANSLATION_WELCOME;
     ?></a>
    <ul>
  ...
  <?php if($acl -> hasPermission("banners") or $acl -> hasPermission("pages") or $acl -> hasPermission("categories")){
         ?>
 <li>
    <a href='?action=contents'><?php echo TRANSLATION_CONTENTS;
         ?></a>
    <ul>
     <?php if($acl -> hasPermission("pages")){
             ?>
      <li>
        <a href='?action=pages'><?php echo TRANSLATION_PAGES;
             ?></a>
      </li>
      <?php }
         ?>
     ...
     <?php if($acl -> hasPermission("banners")){
             ?>
      <li>
        <a href='?action=banner'><?php echo TRANSLATION_ADVERTISEMENTS;
             ?></a>
      </li>
      ...
      <?php if($acl -> hasPermission("categories")){
             ?>
            <li> 
              <a href='?action=categories'><?php echo TRANSLATION_CATEGORIES;
             ?></a>
            </li>
      <?php }
         ?>
       ...
       <?php if($acl -> hasPermission("import")){
            ...
            <!--
            <li> 
              <a href='?action=import'><?php echo TRANSLATION_IMPORT;
             ?></a>
            </li> -->
      <?php }
         ?>
         ...
         <?php if($acl -> hasPermission("export")){
             ?>
            <li> 
              <a href='?action=export'><?php echo TRANSLATION_EXPORT;
             ?></a>
            </li>
      <?php }
         ?>
  ...
  <?php if($acl -> hasPermission("files") or $acl -> hasPermission("images") or $acl -> hasPermission("flash")){
    ...
    <?php if($acl -> hasPermission("images")){
             ?>
      <li>
        <a href="?action=images"><?php echo TRANSLATION_IMAGES;
             ?></a>
      </li>
      <?php }
         ?>
      ...
      <?php if($acl -> hasPermission("files")){
             ?>
      <li>
        <a href="?action=files"><?php echo TRANSLATION_FILES;
             ?></a>
      </li>
      <?php }
         ?>
  ...
  <?php if($acl -> hasPermission("users")){
         ?><li><a href="?action=admins"><?php echo TRANSLATION_USERS;
         ?></a></li>
  <?php }
     ?>
  <?php if(is_admin() or $acl -> hasPermission("groups")){
         ?>
  <li><a href="?action=groups"><?php echo TRANSLATION_GROUPS;
         ?></a></li>
  <?php }
     ?>
  <?php if($acl -> hasPermission("templates")){
         ?>
  <li>
    <a href="?action=templates"><?php echo TRANSLATION_TEMPLATES;
         ?></a>
    <ul>
      <li>
        <a href="?action=templates&edit=oben.php"><?php echo TRANSLATION_TOP;
         ?></a>
      </li>
      <li>
        <a href="?action=templates&edit=unten.php"><?php echo TRANSLATION_BOTTOM;
         ?></a>
      </li>
      <li>
        <a href="?action=templates&edit=maintenance.php"><?php echo TRANSLATION_MAINTENANCE_PAGE;
         ?></a>
      </li><li>
        <a href="?action=templates&edit=style.css"><?php echo TRANSLATION_CSS;
         ?></a>
      </li>
      <?php
     ...
     <?php
      ...
      <?php
         if(file_exists($theme_dir . "functions.php")){
             ?>
      <li><a href="index.php?action=templates&edit=functions.php"><?php echo TRANSLATION_ADDITIONAL_FUNCTIONS;
             ?></a></li>
     <?php
             }
         ?>
  ...
  <?php if($acl -> hasPermission("list_packages")){
         ?>
  <li><a href="?action=modules"><?php echo TRANSLATION_PACKAGES;
         ?></a>
  ...
  <li><a href="?action=system_update"><?php echo TRANSLATION_UPDATE;
         ?></a></li>
  <?php }
     ?>
    <?php if($acl -> hasPermission("settings_simple") or $acl -> hasPermission("design") or $acl -> hasPermission("spam_filter") or $acl -> hasPermission("cache") or $acl -> hasPermission("motd") or $acl -> hasPermission("pkg_settings") or $acl -> hasPermission("logo") or $acl -> hasPermission("languages") or $acl -> hasPermission("other")){
         ?>
   <li><a href="?action=settings_categories"><?php echo TRANSLATION_SETTINGS;
         ?></a>
   
    <ul>
     <?php if($acl -> hasPermission("settings_simple")){
             ?>
    <li><a href="?action=settings_simple"><?php echo TRANSLATION_GENERAL_SETTINGS;
             ?></a></li>
    <?php }
         ?>
     <?php if($acl -> hasPermission("design")){
             ?>
    <li><a href="?action=design"><?php echo TRANSLATION_DESIGN;
             ?></a></li>
     <?php }
         ?>
     <?php if($acl -> hasPermission("spam_filter")){
             ?>
    <li><a href="?action=spam_filter"><?php echo TRANSLATION_SPAMFILTER;
             ?></a></li>
     <?php }
         ?>
    ...
    <li><a href="?action=cache"><?php echo TRANSLATION_CACHE;
     ...
     <?php if($acl -> hasPermission("motd")){
             ?>
    <li><a href="?action=motd"><?php echo TRANSLATION_MOTD;
             ?></a></a></li>
    <?php }
         ?>
     <?php if($acl -> hasPermission("pkg_settings")){
             ?>
    <li><a href="?action=pkg_settings"><?php echo TRANSLATION_PACKAGE_SOURCE;
             ?></a></li>
    <?php }
         ?>
     <?php if($acl -> hasPermission("logo")){
             ?>
    <li><a href="?action=logo_upload"><?php echo TRANSLATION_LOGO;
             ?></a></li>
    <?php }
         ?>
     <?php if($acl -> hasPermission("languages")){
             ?>
    <li><a href="?action=languages"><?php echo TRANSLATION_LANGUAGES;
             ?></a></li>
    <?php }
         ?>
     ...
     <?php if($acl -> hasPermission("other")){
             ?>
    <li><a href="?action=other_settings"><?php echo TRANSLATION_OTHER;
             ?></a></li>
    <?php }
         ?>
    </ul>
    ...
    <?php if($acl -> hasPermission("info")){
         ?>
    <li><a href="?action=info"><?php echo TRANSLATION_INFO;
         ?></a>
    <ul> 
     <li><a href="http://www.ulicms.de/" target="_blank">UliCMS Portal</a></li>
     <li><a href="http://www.ulicms.de/forum.html" target="_blank">Community</a></li>
     <li><a href="license.html" target="_blank"><?php echo TRANSLATION_LICENSE;
         ?></a></li>
...
$('#clear_cache')
   .click(function (event) {
       ...
       $("#loading").hide();
       $("#message").html("<span style=\"color:green\"><?php echo TRANSLATION_CACHE_WAS_CLEARED;
     ?></span>");
