...
<?php
				...
				echo "<td style=\"text-align:center;\">" . '<a href="index.php?action=key_delete&key=' . htmlspecialchars ( $row->name, ENT_QUOTES ) . '" onclick="return confirm(\'' . TRANSLATION_ASK_FOR_DELETE . '\');"><img src="gfx/delete.gif" class="mobile-big-image" alt="' . TRANSLATION_DELETE . '" title="' . TRANSLATION_DELETE . '"></a></td>';
				echo '</tr>';
			}
		}
		?>
