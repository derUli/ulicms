...
<p><?php translate("require_password_change_notice");?>
</p>
<strong><?php translate("password");?></strong>
<input name="password" id="password" type="password">
<br/><br/>
<strong><?php translate("password_repeat");?></strong>
<input name="password_repeat" id="password_repeat" type="password">
<br/></br>

<input type="submit" value="<?php translate("save_changes");?>" name="change_password">
</form>
