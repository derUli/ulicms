...
<br/><br/>
<strong><?php echo translate("audio_ogg");?></strong><br/>
<input name="ogg_file" type="text" value="<?php echo htmlspecialchars($result->ogg_file);?>"><br/><br/>
<strong><?php echo translate("audio_mp3");?></strong><br/>
<input name="mp3_file" type="text" value="<?php echo htmlspecialchars($result->mp3_file);?>"><br/><br/>
<strong><?php translate("insert_this_code_into_a_page");?></strong><br/>
<input type="text" name="code" value="[audio id=<?php echo $result->id;?>]" onclick="this.focus();this.select();" readonly>
<br/><br/>
