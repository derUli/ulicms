...
<?php
		foreach ( getAllMenus () as $menu ) {
			?>
<option value="<?php echo $menu?>"><?php
...
echo TRANSLATION_PARENT;
		...
		<option selected="selected" value="NULL">[<?php
