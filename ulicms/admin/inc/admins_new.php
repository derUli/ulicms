...
<?php
	...
	<input type="text" required name="admin_username" value=""> <br /> <br />
	...
	<input type="text" required name="admin_password" value=""><br /> <br />
	<input type="checkbox" value="1" name="require_password_change"
		id="require_password_change"> <label for="require_password_change"><?php
			
			translate ( "REQUIRE_PASSWORD_CHANGE_ON_NEXT_LOGIN" );
			?> </label> <br /> <br /> <input type="checkbox" id="send_mail"
		name="send_mail" value="sendmail"> <label for="send_mail"><?php translate("SEND_LOGINDATA_BY_MAIL");?></label>
