<form role="form" id="admin-login" method="post"
	...
	<div class="form-group">
		<label for="text"><?php echo TRANSLATION_ADMIN_USER;?></label> <input
			...
			value="<?php echo htmlspecialchars($_SESSION["admin_user"]);?>" required>
	</div>
	...
	<div class="form-group">
		<label for="text"><?php echo TRANSLATION_ADMIN_PASSWORD;?></label> <input
			...
			id="admin_password"
			value="<?php echo htmlspecialchars($_SESSION["admin_password"]);?>" required>
	</div>

	<div class="form-group">
		<label for="text"><?php echo TRANSLATION_ADMIN_PASSWORD_REPEAT;?></label>
		<input type="password" class="form-control"
			name="admin_password_repeat" id="admin_password_repeat" value="" required>
	</div>
	...
	<div class="form-group">
		<label for="text"><?php echo TRANSLATION_ADMIN_LASTNAME;?></label> <input
			...
			id="admin_lastname"
			value="<?php echo htmlspecialchars($_SESSION["admin_lastname"]);?>" required>
	</div>
	...
	<div class="form-group">
		<label for="text"><?php echo TRANSLATION_ADMIN_FIRSTNAME;?></label> <input
			...
			id="admin_firstname"
			value="<?php echo htmlspecialchars($_SESSION["admin_firstname"]);?>" required>
	</div>
