...
class User
{
    ...
    private $secondaryGroupIds = array();
    ...
    private function loadGroups()
    {
        ...
        $this->secondaryGroupIds = array();
        while ($row = Database::fetchObject($query)) {
            $this->secondaryGroupIds[] = $row->group_id;
        }
    }
    ...
    private function saveGroups()
    {
        ...
        foreach ($this->secondaryGroupIds as $id) {
            if (! in_array($id, $groupsInDb)) {
                Database::pQuery("insert into {prefix}user_groups (user_id, group_id) values (?,?)", array(
                    $this->id,
                    $id
                ), true);
            }
    ...
    public function setSecondaryGroupIds($ids)
    {
        $this->secondaryGroupIds = $ids;
    }
