...
class PackageManager
{
    ...
    public function installPackage($file, $clear_cache = true)
    {
        ...
        try {
            ...
            if (startsWith(ULICMS_ROOT, "gs://") and class_exists("GoogleCloudHelper")) {
                GoogleCloudHelper::makeFilesPublic(ULICMS_ROOT);
            }
    ...
    {
        $module_folder = Path::resolve("ULICMS_ROOT/content/modules") . "/";
