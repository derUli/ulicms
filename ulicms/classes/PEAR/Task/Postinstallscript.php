...
class PEAR_Task_Postinstallscript extends PEAR_Task_Common {
	 ...
	 * @param array $
	 *        	The XML contents of the <postinstallscript> tag
	 * @param PEAR_Config $        	
	 * @param array $
	 *        	the entire parsed <file> tag
	 * @static
	 *
	 */
	 ...
	 *        	raw, parsed xml
	 * @param array $
	 *        	attributes from the <file> tag containing this task
	 * @param string $
	 *        	|null last installed version of this package, if any (useful for upgrades)
	 */
