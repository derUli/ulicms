...
class PEAR_Downloader_Package {
	 ...
	 *
	 * @param array $
	 *        	of PEAR_Downloader_Package objects
	 * @static
	 *
	 */
	 ...
	 *
	 * @param array $
	 *        	Parsed array from {@link PEAR_Registry::parsePackageName()} or a dependency
	 ...
	 * @param array $        	
	 * @param bool $
	 *        	ignore install groups - for final removal of dupe packages
	 * @static
	 *
	 */
	 ...
	 *
	 * @param string $
	 *        	|array can be a parsed package name as well
	 * @access private
	 */
	 ...
	 *
	 * @param array $
	 *        	output of package.getDownloadURL
	 * @param string $
	 *        	|array|object information for detecting packages to be downloaded, and
	 *        	for errors
	 * @param array $
	 *        	name information of the package
	 * @param array $
	 *        	|null packages to be downloaded
	 * @param bool $
	 *        	is this an optional dependency?
	 * @param bool $
	 *        	is this any kind of dependency?
	 * @access private
	 */
