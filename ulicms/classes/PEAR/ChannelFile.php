...
";
	 ...
	 *
	 * @param string $
	 *        	rest - protocol name this function applies to
	 * @param array $
	 *        	the functions
	 * @param string $
	 *        	the name of the parent element (mirror name, for instance)
	 */
	 ...
	 *        	Protocol type
	 * @param string $
	 *        	Function name (null to return the
	 ...
	 * @param integer $        	
	 * @param string $
	 *        	|false name of the mirror server, or false for the primary
	 */
	 ...
	 * @param string $        	
	 * @param boolean $
	 *        	determines whether the alias is in channel.xml or local
	 * @return boolean success
	 */
	 ...
	 *
	 * @param string $
	 *        	|false pass in false to reset to the default packagename regex
	 * @return boolean success
	 */
	 ...
	 *        	URL
	 * @param string $
	 *        	|false mirror name, if this is not a primary server REST base URL
	 */
	 ...
	 *
	 * @param string $
	 *        	|false the name of the package to validate. If the package is
