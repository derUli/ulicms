...
3: debug',
	 ...
	 * @param bool $
	 *        	determines whether a registry object "follows"
	 *        	the value of php_dir (is automatically created
	 *        	and moved when php_dir is changed)
	 * @param bool $
	 *        	if true, fails if configuration files cannot be loaded
	 * @access public
	 ...
	 *
	 * @param string $
	 *        	(optional) file to read user-defined options from
	 * @param string $
	 *        	(optional) file to read system-wide defaults from
	 ...
	 *
	 * @param string $
	 *        	file to read from, if NULL or not specified, the
	 ...
	 *        	config layer to insert data into ('user' or 'system')
	 * @param string $
	 *        	if true, errors are returned if file opening fails
	 * @return bool TRUE on success or a PEAR error on failure
	 */
	 ...
	 *
	 * @param string $
	 *        	|null file to read from, or null for default
	 * @param string $
	 *        	config layer to insert data into ('user' or
	 *        	'system')
	 * @param string $
	 *        	|null data to write to config file or null for internal data [DEPRECATED]
	 * @return bool TRUE on success or a PEAR error on failure
	 */
	 ...
	 *
	 * @param string $
	 *        	Configuration class name, used for detecting duplicate calls
	 * @param array $
	 *        	information on a role as parsed from its xml file
	 * @return true |PEAR_Error
	 * @access private
	 */
	 ...
	 *
	 * @param array $
	 *        	(reference) array to encode values in
	 ...
	 * @param string $
	 *        	channel to set this value for, or null for global value
	 ...
	 *        	(optional) config layer
	 * @param string $
	 *        	(optional) channel (defaults to default channel)
	 * @return bool TRUE on success, FALSE on failure
	 * @access public
	 */
	 ...
	 *
	 * @param string $
	 *        	|false installation directory to prepend to all _dir variables, or false to
	 *        	disable
	 */
