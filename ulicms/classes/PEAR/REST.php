...
class PEAR_REST {
	 ...
	 * @param array $
	 *        	|false contents of the accept-encoding header
	 * @param boolean $
	 ...
	 *
	 * @param string $
	 *        	full URL to REST resource
	 * @param string $
	 *        	original contents of the REST resource
	 * @param array $
	 *        	HTTP Last-Modified and ETag headers
	 * @param bool $
	 *        	if true, then the cache id file should be regenerated to
