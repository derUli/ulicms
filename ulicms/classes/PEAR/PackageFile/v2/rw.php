...
class PEAR_PackageFile_v2_rw extends PEAR_PackageFile_v2 {
	 ...
	 *
	 * @param string $
	 *        	base installation dir for the whole package, if any
	 */
	 ...
	 *
	 * @param string $
	 *        	relative path of the bundled package.
	 */
	 ...
	 * @param string $
	 *        	Dependent package's channel name
	 * @param string $
	 *        	minimum version of specified package that this release is guaranteed to be
	 *        	compatible with
	 * @param string $
	 *        	maximum version of specified package that this release is guaranteed to be
	 *        	compatible with
	 * @param string $
	 *        	versions of specified package that this release is not compatible with
	 */
	 ...
	 *
	 * @param string $
	 *        	minimum allowed PEAR installer version
	 * @param string $
	 *        	maximum allowed PEAR installer version
	 * @param string $
	 *        	recommended PEAR installer version
	 * @param array $
	 *        	incompatible version of the PEAR installer
	 */
	 ...
	 *        	package channel
	 * @param string $
	 *        	extension this package provides, if any
	 * @param string $
	 *        	|false minimum version required
	 * @param string $
	 *        	|false maximum version allowed
	 * @param array $
	 *        	|false versions to exclude from installation
	 */
	 ...
	 *        	package name
	 * @param string $
	 *        	|false channel name, false if this is a uri
	 * @param string $
	 *        	|false uri name, false if this is a channel
	 * @param string $
	 *        	|false minimum version required
	 * @param string $
	 *        	|false maximum version allowed
	 * @param string $
	 *        	|false recommended installation version
	 * @param array $
	 *        	|false versions to exclude from installation
	 * @param string $
	 *        	extension this package provides, if any
	 * @param bool $
	 *        	if true, tells the installer to ignore the default optional dependency group
	 *        	when installing this package
	 * @param bool $
	 *        	if true, tells the installer to negate this dependency (conflicts)
	 * @return array
	 * @access private
	 */
	 ...
	 *
	 * @param string $
	 *        	group name (must be pre-existing)
	 * @param string $
	 *        	extension name
	 * @param string $
	 ...
	 *        	dependency contents
	 * @param string $
	 *        	name of the dependency group to add this to
	 * @return boolean
	 * @access private
	 */
	 ...
	 * @param boolean $
	 *        	true if this package cannot be installed on this OS
	 */
	 ...
	 *
	 * @param string $
	 *        	Architecture matching pattern
	 * @param boolean $
	 *        	true if this package cannot be installed on this architecture
	 */
	 ...
	 *
	 * @param php $
	 *        	|extbin|extsrc|zendextsrc|zendextbin|bundle
	 * @return bool success
	 */
	 ...
	 *
	 * @param bool $
	 *        	returns only releases that have installcondition if true
	 * @return array |null
	 */
	 ...
	 * @param string $
	 *        	name the file should be installed as
	 */
	 ...
	 *        	maximum version
	 * @param false $
	 *        	|array incompatible versions of PHP
	 */
	 ...
	 *        	OS name
	 * @param bool $
	 *        	whether this OS is incompatible with the current release
	 */
	 ...
	 * @param bool $
	 *        	whether this arch is incompatible with the current release
	 */
	 ...
	 *
	 * @param string $
	 *        	Package name, or full URI to source package (extsrc/zendextsrc type)
	 */
	 ...
	 *
	 * @param string $
	 *        	release version to set change log notes for
	 * @param array $
	 *        	output of {@link generateChangeLogEntry()}
	 */
