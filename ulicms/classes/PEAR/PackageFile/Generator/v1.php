...
class PEAR_PackageFile_Generator_v1 {
	 ...
	 * @param PEAR_Packager $        	
	 * @param bool $
	 *        	if true, a .tgz is written, otherwise a .tar is written
	 * @param string $
	 *        	|null directory in which to save the .tgz
	 ...
	 *
	 * @param string $
	 *        	|null directory to place the package.xml in, or null for a temporary dir
	 * @param int $
	 *        	one of the PEAR_VALIDATE_* constants
	 * @param string $
	 *        	name of the generated file
	 * @param bool $
	 *        	if true, then no analysis will be performed on role="php" files
	 ...
	 *
	 * @param string $
	 *        	the classname to instantiate and return. This must be
	 *        	PEAR_PackageFile_v2 or a descendant
	 * @param boolean $
	 *        	if true, only valid, deterministic package.xml 1.0 as defined by the
