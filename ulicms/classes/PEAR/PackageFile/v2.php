...
class PEAR_PackageFile_v2 {
	 ...
	 *        	options
	 * @param array $
	 *        	package name as returned from {@link PEAR_Registry::parsePackageName()}
	 * @param int $
	 *        	PEAR_VALIDATE_* constant
	 ...
	 *
	 * @param array $
	 *        	the final flattened file list
	 * @param array $
	 *        	the current directory being processed
	 * @param string $
	 *        	|false any recursively inherited baeinstalldir attribute
	 * @param string $
	 ...
	 *
	 * @param package $
	 *        	|api version category to return
	 */
					...
					if (is_array ( $installconditions )) {
						...
						foreach ( $installconditions as $type => $conditions ) {
							...
							foreach ( $conditions as $condition ) {
								$ret = $depchecker->{
                                    "validate{$type}Dependency"} ( $condition );
								if (PEAR::isError ( $ret )) {
									PEAR::popErrorHandling ();
	 ...
	 *        	attribute value
	 * @param int $
	 *        	risky but fast - use this to choose a file based on its position in the list
	 ...
	 *        	|PEAR_PackageFile_v1|PEAR_Downloader_Package
	 * @return boolean
	 */
	 ...
	 *
	 * @param boolean $
	 *        	return package.xml 2.0 <dependencies> tag
	 * @return array |false
	 */
	 ...
	 *
	 * @param tagname $
	 *        	to splice a value in before
	 * @param mixed $
	 *        	the value to splice in
	 * @param string $
	 *        	the new tag name
	 */
	 ...
	 *
	 * @param array $
	 *        	a list of possible keys, in the order they may occur
	 * @param mixed $
	 *        	contents of the new package.xml tag
	 * @param string $
	 *        	tag name
	 * @access private
	 */
