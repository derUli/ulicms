...
class PEAR_Installer extends PEAR_Downloader {
	 ...
	 *        	channel name
	 * @param bool $
	 *        	if true, then files are backed up first
	 ...
	 *        	filename
	 * @param array $
	 *        	attributes from <file> tag in package.xml
	 * @param string $
	 *        	path to install the file in
	 * @param array $
	...
	function _installFile2(& $pkg, $file, & $real_atts, $tmp_path, $options) {
		...
		// {{{ assemble the destination paths
		if (! faster_in_array ( $atts ['attribs'] ['role'], PEAR_Installer_Role::getValidRoles ( $pkg->getPackageType () ) )) {
	 ...
	 *
	 * @param array $
	 *        	a mixed list of package names, local files, or package.xml
	 * @param PEAR_Config $        	
	 * @param array $
	 *        	options from the command line
	 * @param array $
	 *        	this is the array that will be populated with packages to
	 ...
	 *        	</code>
	 * @param array $
	 *        	this will be populated with any error messages
	 * @param false $
	 ...
	 *
	 * @param string $
	 *        	|PEAR_Downloader_Package $pkgfile path to the package file,
	 ...
	 *
	 * @param array $
	 *        	an array of PEAR_PackageFile_v[1/2] objects
