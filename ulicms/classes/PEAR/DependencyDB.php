...
class PEAR_DependencyDB {
	 ...
	 * @param PEAR_Config $        	
	 * @param string $
	 *        	|false full path to the dependency database, or false to use default
	 ...
	 *
	 * @param PEAR_PackageFile_v1 $
	 *        	|PEAR_PackageFile_v2|array If an array, then it must have
	 ...
	 * @param required $
	 *        	|optional whether this is a required or an optional dep
	 * @param string $
	 *        	|false dependency group this dependency is from, or false for ordinary dep
	 */
