...
class PEAR_Dependency2 {
	 ...
	 *
	 * @param array $
	 *        	dependency information (2.0 format)
	 * @param boolean $
	 *        	whether this is a required dependency
	 * @param array $
	 *        	a list of downloaded packages to be installed, if any
	 * @param boolean $
	 ...
	 *
	 * @param array $
	 *        	|PEAR_Downloader_Package|PEAR_PackageFile_v1|PEAR_PackageFile_v2
	...
	function validateDependency1($dep, $params = array()) {
		...
		if (method_exists ( $this, "validate{$type}Dependency" )) {
			return $this->{
                "validate{$type}Dependency"} ( $newdep, $dep ['optional'] == 'no', $params, true );
		}
	}
