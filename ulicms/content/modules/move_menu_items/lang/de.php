<?php
define ( "TRANSLATION_MOVE", "Verschieben" );
...
define ( "TRANSLATION_X_DATASET_MOVED", "%count% Datensatz verschoben." );
define ( "TRANSLATION_X_DATASETS_MOVED", "%count% Datensätze verschoben." );