...
add_translation("ip_address", "IP Address");

add_translation("write_a_comment", "Write a Comment");
add_translation("post_comment", "Send comment");

add_translation("your_name", "Your Name");
