...
<p>
    ...
    if ($permissionChecker->hasPermission("pages")) {
        ?>
	<a href="index.php?action=pages" class="btn btn-default"><?php translate("pages");?></a><br />
	<?php
    }
    ?>
    <?php
    if ($permissionChecker->hasPermission("comments_manage")) {
        ?>
	<a href="?action=comments_manage" class="btn btn-default voffset2"><?php translate("comments");?></a><br />
	<?php
    }
    ?>
    <?php
    if ($permissionChecker->hasPermission("forms")) {
        ?><a href='?action=forms' class="btn btn-default voffset2"><?php
    ...
    if ($permissionChecker->hasPermission("banners")) {
        ?>
	<a href="index.php?action=banner" class="btn btn-default voffset2"><?php translate("advertisements");?></a><br />

	<?php
    }
    if ($permissionChecker->hasPermission("categories")) {
        ?>
	<a href="index.php?action=categories" class="btn btn-default voffset2"><?php translate("categories");?></a><br />
	<br />
	<?php
    }
