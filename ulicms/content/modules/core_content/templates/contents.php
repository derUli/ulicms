...
if ($permissionChecker->hasPermission("pages") || $permissionChecker->hasPermission("banners") || $permissionChecker->hasPermission("categories") || $permissionChecker->hasPermission("export") || $permissionChecker->hasPermission("forms")) {
    ?>
