...
if ($permissionChecker->hasPermission("pages")
    ...
    <div id="accordion-container">
            ...
            <div class="typedep menu-stuff">
             ...
             <div class="field">
                ...
                <div id="parent-div" class="field">
                    <strong class="field-label"><?php translate("parent_id"); ?></strong><br /> <select
        ...
        <div class="typedep field" id="tab-target">
            <strong class="field-label"><?php
                translate("open_in");
                ?>
            </strong>
        ...
        <div class="typedep field" id="hidden-attrib">
    ...
    <div class="typedep" id="tab-link" style="display: none;">
        ...
        <div class="accordion-content">
            <strong class="field-label"><?php translate("link_url"); ?>
            </strong>
    ...
    <div class="typedep" id="tab-list" style="display: none">
        ...
        <div class="accordion-content">
            <strong class="field-label"><?php translate("type") ?></strong> <br />
            ...
            <select name="list_type">
                ...
                ?>
            </select> <br /> <br /> <strong class="field-label"><?php translate("language"); ?>
                ...
                ?>
            </select> <br /> <br /> <strong class="field-label"><?php translate("category"); ?>
            </strong><br />
            <?php echo Categories :: getHTMLSelect(-1, true, "list_category") ?>
            <br /> <br /> <strong class="field-label"><?php
                translate("menu");
                ?>
                ...
                ?>
            </select> <br /> <br /> <strong class="field-label"><?php translate("parent_id"); ?>
                ...
                ?>
            </select> <br /> <br /> <strong class="field-label"><?php
                translate("order_by");
                ?>
            ...
            </select> <br /> <br /> <strong class="field-label"><?php translate("entries_per_page"); ?></strong>
            <input type="number" min="0" name="limit" step="1" value="0"> <br />
            <strong class="field-label"><?php translate("use_pagination"); ?></strong><br /> <select
    ...
    <div class="typedep" id="tab-module" style="display: none;">
        ...
        <div class="accordion-content">
            <strong class="field-label"><?php translate("module"); ?></strong><br /> <select
                name="module">
    ...
    <div class="typedep" id="tab-video" style="display: none;">
        ...
        <div class="accordion-content">
            <strong class="field-label"><?php translate("video"); ?></strong><br /> <select
                name="video">
                <option value="">[<?php translate("none"); ?>]</option>
    ...
    <div class="typedep" id="tab-audio" style="display: none;">
        ...
        <div class="accordion-content">
            <strong class="field-label"><?php translate("audio"); ?></strong><br /> <select
                name="audio">
                <option value="">[<?php translate("none"); ?>]</option>
    ...
    <div class="typedep" id="tab-comments">
        ...
        <div class="accordion-content">
            <strong class="field-label"><?php translate("comments_enabled"); ?></strong> <br /> <select
    ...
    <div class="accordion-content">
        <div class="typedep" id="tab-cache-control" style="display: none;">
            <strong class="field-label"><?php translate("cache_control"); ?></strong> <br /> <select
                name="cache_control">
        ...
        <div class="typedep" id="tab-menu-image">
            <strong class="field-label"><?php translate("design"); ?></strong><br /> <select
                name="theme" size=1>
                <option value="">
                    [
        ...
        <br /> <strong class="field-label"><?php translate("visible_for"); ?>
