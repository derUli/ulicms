	...
	<div class="typedep" id="tab-og" style="display: none">
		...
		<div class="accordion-content">
			...
			<div style="margin-left: 20px;">
                ...
                ?>"> <br /> <strong><?php translate("image");?></strong>
				<br />
				<script type="text/javascript">
function openMenuImageSelectWindow(field) {
    window.KCFinder = {
...
<?php
	...
	<?php } ?>
		...
		<input type="checkbox" name="only_admins_can_edit"
			...
			<?php if($permissions->getEditRestriction("admins")) echo "checked";?>>
		<label for="only_admins_can_edit"><?php translate("admins");?></label>
		<br /> <input type="checkbox" name="only_group_can_edit"
			id="only_group_can_edit" value="1"
			<?php if($permissions->getEditRestriction("group")) echo "checked";?>>
		<label for="only_group_can_edit"><?php translate("group");?></label> <br />
		<input type="checkbox" name="only_owner_can_edit"
			id="only_owner_can_edit" value="1"
			<?php if($permissions->getEditRestriction("owner")) echo "checked";?>>
		<label for="only_owner_can_edit"><?php translate("owner");?></label> <br />
		<input type="checkbox" name="only_others_can_edit"
			id="only_others_can_edit" value="1"
			<?php if($permissions->getEditRestriction("others")) echo "checked";?>>
