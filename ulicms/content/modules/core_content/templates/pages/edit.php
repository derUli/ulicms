            ...
            <div class="pageform" style="display: none">
                ...
                <div id="accordion-container">
                    ...
                    <div class="accordion-content">
                                ...
                                <?php foreach ($types as $type) { ?>
                                    <div>
                                        <input type="radio" name="type" id="type_<?php echo $type; ?>"
                                               ...
                                               for="type_<?php echo $type; ?>"><?php translate($type); ?></label>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="accordion-content">
                            ...
                            <div class="typedep menu-stuff">
                                <strong class="field-label"><?php translate("menu"); ?> </strong> <span
                                ...
                                <strong class="field-label"><?php translate("position"); ?> </strong> <span
                                    style="cursor: help;"
                                    onclick="$('div#position_help').slideToggle()"><i class="fa fa-question-circle text-info" aria-hidden="true"></i></span> <input
                                ...
                                <div class="typedep" id="parent-div">
                                    <strong class="field-label"><?php translate("parent_id"); ?> </strong> <select
                            ...
                            <strong class="field-label"><?php translate("activated"); ?> </strong> <select
                                name="active" size=1
                            ...
                            <div class="typedep" id="tab-target">
                                <strong class="field-label"><?php translate("open_in"); ?></strong> <select
                                    name="target" size=1>
                                    <option
                                    <?php
                                    if ($row->target == "_self") {
                            ...
                            <div class="typedep" id="hidden-attrib">
                                <strong class="field-label"><?php translate("hidden"); ?>
                                </strong> <select name="hidden" size="1"><option value="1">
                                        <?php translate("yes"); ?>
                                    </option>
                            ...
                            <div id="menu_image_div" class="voffset3">
                                <strong class="field-label"><?php translate("menu_image"); ?> </strong>
                        ...
                        <div class="typedep" id="tab-link">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("link_url"); ?></strong> <input
                        ...
                        <div class="typedep" id="tab-language-link" style="display: none;">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("language_link"); ?>
                                </strong>
                                <?php
                        ...
                        <div class="typedep" id="tab-metadata" style="display: none">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("meta_description"); ?></strong> <input
                                    type="text" name="meta_description"
                                    value="<?php
                                    esc($row->meta_description);
                                    ?>"
                                    maxlength="200">  <strong class="field-label"><?php translate("meta_keywords"); ?></strong>
                                ...
                                <div class="typedep" id="article-metadata">
                                    <strong class="field-label"><?php translate("author_name"); ?></strong> <input
                                        type="text" name="article_author_name"
                                        value="<?php echo _esc($row->article_author_name); ?>"
                                        maxlength="80">  <strong class="field-label"><?php translate("author_email"); ?></strong>
                                ...
                                <div class="typedep" id="tab-og" style="display: none">
                                    ...
                                    <strong class="field-label"><?php translate("title"); ?>
                                    </strong> <input type="text" name="og_title"
                                                     value="<?php
                                                     esc($row->og_title);
                                                     ?>">  <strong class="field-label"><?php translate("description"); ?>
                                    </strong> <input type="text" name="og_description"
                                                     value="<?php
                        ...
                        <div class="typedep list-show" id="tab-list">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("type") ?></strong>
                                ...
                                <select name="list_type">
                                    ...
                                    ?>
                                </select>   <strong class="field-label"><?php translate("language"); ?>
                                </strong>  <select name="list_language">
                                    <option value=""
                                    <?php
                                    ...
                                    ?>>[<?php translate("every"); ?>]</option>
                                            ...
                                            ?>
                                </select>   <strong class="field-label"><?php
                                    translate("category");
                                    ?>
                                </strong>
                                <?php
                                ...
                                <select name="list_menu" size="1">
                                    ...
                                    ?>
                                </select>   <strong class="field-label"><?php translate("parent_id"); ?>
                                </strong> <select name="list_parent" size=1>
                                    <option
                                    <?php
                                    ...
                                    translate("order_by");
                                    ?>
                                </strong>  <select name="list_order_by">
                                ...
                                <strong class="field-label"><?php translate("entries_per_page"); ?></strong>
                                <input type="number" name="limit" min="0" step="1"
                                       value="<?php echo intval($list_data->limit); ?>">  <strong class="field-label"><?php translate("use_pagination"); ?></strong>
                        ...
                        <div class="typedep" id="tab-module" style="display: none;">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("module"); ?></strong> <select
                                    name="module">
                                    <option value="null"
                        ...
                        <div class="typedep" id="tab-video" style="display: none;">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("video"); ?></strong> <select
                                    name="video">
                                    <option value=""
                        ...
                        <div class="typedep" id="tab-audio" style="display: none;">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("audio"); ?></strong> <select
                                    name="audio">
                                    <option value=""
                        ...
                        <div class="typedep" id="tab-text-position" style="display: none">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("position_of_description"); ?>
                                </strong>  <select name="text_position">
                                    <option value="before"
                                    <?php
                        ...
                        <div class="typedep" id="article-image">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("article_image"); ?>
                                </strong>
                        ...
                        <div style="<?php echo!$permissionChecker->hasPermission("pages_edit_permissions") ? "display:none" : "" ?>">
                            ...
                            <div class="accordion-content">
                                <strong class="field-label"><?php translate("owner"); ?> <?php translate("user"); ?></strong>
                                ...
                                ?>>
                                        ...
                                        <option value="<?php Template::escape($user["id"]); ?>"
                                            ...
                                            <?php } ?>
                                </select>   <strong class="field-label"><?php translate("owner"); ?> <?php translate("group"); ?></strong>
                                ...
                                ?>>
                                        ...
                                        <option value="<?php Template::escape($group->getId()); ?>"
                                            ...
                                            <?php } ?>
                                </select>   <strong class="field-label"><?php translate("restrict_edit_access"); ?></strong>
                        ...
                        <div class="accordion-content">
                            <div class="typedep" id="tab-cache-control" style="display: none;">
                                <strong class="field-label"><?php translate("cache_control"); ?></strong>  <select
                                    name="cache_control">
                                    <option value="auto"
                                    <?php
                            ...
                            <div class="typedep" id="tab-menu-image">
                                <strong class="field-label"><?php translate("design"); ?></strong> <select
                                    name="theme" size=1>
                                    <option value="">
                                        [
                            ...
                            <strong class="field-label"><?php translate("visible_for"); ?> </strong>
                            <?php
                    ...
                    <div class="typedep" id="content-editor">
                        <p>
                            <textarea name="content" id="content" cols=60 rows=20 class="<?php esc($editor); ?>" data-mimetype="text/html"><?php
                                esc($row->content);
                                ?></textarea>
                        </p>
                        <?php
