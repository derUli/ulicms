...
if ($permissionChecker->hasPermission("settings_simple")) {
    ...
    <table>
        ...
        <tr>
            <td>
                <strong><?php
                    translate("enable_password_reset"); ?></strong>
            </td>
            <td><input type="checkbox" name="disable_password_reset"
                       value="enable"
                       class="js-switch"

                       <?php if (!isset($settings["disable_password_reset"])) {
                        echo " checked";
                    } ?>>
            </td>
        </tr>
        ...
        <tr>
            <td><strong><?php
                    translate("description"); ?></strong></td>
