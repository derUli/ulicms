    ...
    if (db_num_rows($result) > 0) {
        ...
        <form action="index.php?sClass=AudioController&sMethod=update"
            ...
            <br /> <br /> <strong><?php echo translate("audio_ogg"); ?>
                                   ...
                                   value="<?php echo _esc($dataset->ogg_file); ?>"><br /> <strong><?php translate("audio_mp3"); ?>
            </strong><br /> <input name="mp3_file" type="text"
                                   value="<?php echo _esc($dataset->mp3_file); ?>"><br /> <strong><?php translate("insert_this_code_into_a_page"); ?>
            </strong><br /> <input type="text" name="code"
                                   value="[audio id=<?php echo $dataset->id; ?>]" class="select-on-click" readonly> <br />
