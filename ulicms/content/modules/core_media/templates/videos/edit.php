    ...
    if (db_num_rows($result) > 0) {
        ...
        <form action="index.php?sClass=VideoController&sMethod=update"
            ...
            <br /> <br /> <strong><?php translate("video_ogg"); ?>
                                   ...
                                   ?>">
            <br />
            <strong><?php translate("video_webm"); ?></strong>
            <br />
            <input name="webm_file" type="text"
                   value="<?php echo _esc($dataset->webm_file); ?>">
            <br />
            <strong><?php echo translate("video_mp4"); ?></strong>
            <br />
            <input name="mp4_file" type="text"
                   value="<?php echo _esc($dataset->mp4_file); ?>">
            <br />
            <strong><?php translate("width"); ?></strong>
            <br />
