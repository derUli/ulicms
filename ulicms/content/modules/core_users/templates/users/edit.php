    ...
    while ($row = db_fetch_object($result)) {
        ...
        <div class="field">
            <strong class="field-label">
                ...
                <option value="ckeditor"
                        <?php if (!$row->html_editor or $row->html_editor == "ckeditor") {
                    echo "selected";
                } ?>>CKEditor</option>
                <option value="codemirror"
                        <?php if ($row->html_editor == "codemirror") {
                    echo "selected";
                } ?>>CodeMirror</option>
            </select>
        </div>
        <div class="checkbox block">
            <label>
                <input type="checkbox" value="1"
                       ...
                       translate("REQUIRE_PASSWORD_CHANGE_ON_NEXT_LOGIN"); ?> </label>
        </div>
        <?php
        if ($permissionChecker->hasPermission("users")) {
            ?>
        ...
        <div class="field">
            ...
            <select name="default_language">
                <option value="" <?php if (!$row->default_language) {
            echo " selected";
