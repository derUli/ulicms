...
class UserController extends Controller
{
    ...
    public function createPost()
    {
        ...
        // TODO: Use User Model instead
        $id = adduser($username, $lastname, $firstname, $email, $password, $sendMail, $group_id, $require_password_change, $admin, $locked, $default_language);
        $group_ids = is_array($_POST["group_ids"]) ? $_POST["group_ids"] : array();
        $user = new User($id);
        $user->setSecondaryGroupIds($group_ids);
        $user->save();
