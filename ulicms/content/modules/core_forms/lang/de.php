...
add_translation("cyrillic_chars_not_allowed", "Kyrillische Schriftzeichen sind nicht erlaubt!");
add_translation("rtl_chars_not_allowed", "Right-To-Left Sprachen sind nicht erlaubt!");

add_translation("request_contains_badword", "Die Anfrage enthalt ein nicht erlaubtes Wort: %word%");
