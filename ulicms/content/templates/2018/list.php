...
if ($id !== null) {
  ...
  <div class="row article-list-row">
	<p><strong><a
		href="<?php Template::escape(buildSEOUrl($entry->systemname));?>"><?php Template::escape($entry->title);?></a></strong></p>
    ...
    <div class="col-sm-5">
		<?php if($meta and !empty($meta->article_image)){
			...
			?>
		<p><a href="<?php Template::escape(buildSEOUrl($entry->systemname));?>" class="list-article-image"><img src="<?php echo $article_image;?>" alt="Screenshot <?php Template::escape($entry->title);?>" class="article-image"></a></p>
	...
	<p><a href="<?php Template::escape(buildSEOUrl($entry->systemname));?>">Mehr Informationen</a></p>
	</div>
	</div>
	<?php }?>
...
<?php }?>
                ...
                <a class="fa fa-rss fa-4x" href="<?php Template::escape(buildSEOUrl(false, null, "rss"));?>"
                   title="Newsfeed"></a>
                </div>
<?php }?>
	<?php
