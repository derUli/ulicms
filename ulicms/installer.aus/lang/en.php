...
define("TRANSLATION_PHP_VERSION_TOO_LOW", "Your server is running PHP " . phpversion() . ".<br/>" .
     "It is recommend to upgrade to PHP " . REQUIRED_PHP_VERSION . " or better, or some functions of UliCMS will not be available.");
